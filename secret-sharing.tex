...
\begin{document}
	...
	\subsection{\texorpdfstring{$ (2,n) $}{(2,n)}-Schema}
	...
	\subsection{\texorpdfstring{$ (3,n) $}{(3,n)}-Schema}
	...
	\subsection{Allgemeine \texorpdfstring{$ (k,n) $}{(k,n)}-Schemata}
		Blah % TODO (k,n) $-Schema
	
	\subsection{Shamir's Secret Sharing \texorpdfstring{$ x \bmod p $}{x mod p}}
