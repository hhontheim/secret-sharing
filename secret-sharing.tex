...
\begin{document}
	...
	\begin{bsp}Blah\\
		\begin{figure}[h]
		\begin{adjustbox}{center,rotate=0,caption={eine Grafik ohne Sinn und Verstand}}
			\begin{tikzpicture}[line cap=round,line join=round,>=triangle 45,x=0.015cm,y=0.015cm]
				...
				\draw[color=green] (600.,100.) node {$ \bullet $};
			...
			\end{tikzpicture}
		\end{adjustbox}
		\caption{Erweiterung des Geheimnisses $ s $ auf Gerade $ f $ für zwei Shares}
	\end{figure}
	\end{bsp}
